...
interface AuthContextType {
  ...
  logout: () => void;
  register: (email: string, password: string, username: string, nomor_telepon: string) => Promise<boolean>;
}
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const register = async (email: string, password: string, username: string, nomor_telepon: string): Promise<boolean> => {
